          ...
          <div className="mx-auto w-full max-w-screen-xl">
            ...
            <div className="px-4 py-6 bg-neutral-secondary-soft md:flex md:items-center md:justify-between">
              <span className="text-sm text-body sm:text-center">
                ...
                <a href="https://github.com/Changrui-ZHANG">Changrui ZHANG</a>
              ...
              <div className="flex mt-4 sm:justify-center md:mt-0 space-x-2 rtl:space-x-reverse">
                ...
                >
                  ...
                  >
                    <path
                      fill-rule="evenodd"
                      d="M4.98 3.5C4.98 4.88 3.88 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1s2.48 1.12 2.48 2.5zM.22 8.99h4.56V24H.22V8.99zm7.5 0h4.37v2.03h.06c.61-1.15 2.11-2.36 4.34-2.36 4.64 0 5.5 3.05 5.5 7.01V24h-4.56v-7.75c0-1.85-.03-4.23-2.58-4.23-2.58 0-2.97 2.01-2.97 4.09V24H7.72V8.99z"
                      clip-rule="evenodd"
                    />
                  </svg>
                </a>
                {/*GitHub*/}
                <a
                  href="https://github.com/Changrui-ZHANG/cvitefront"
                  className="text-body hover:text-heading ms-5"
                >
                  <svg
                    className="w-5 h-5"
